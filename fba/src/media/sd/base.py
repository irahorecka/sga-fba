...
sd = {
    ...
    # AA
    media_reagents["L-alanine"]: 0.0,
    media_reagents["L-arginine"]: 0.0,
    media_reagents["L-asparagine"]: 0.0,
    media_reagents["L-aspartate"]: 0.0,
    media_reagents["L-cysteine"]: 0.0,
    media_reagents["L-glutamate"]: 0.0,
    media_reagents["L-glutamine"]: 0.0,
    media_reagents["L-glycine"]: 0.0,
    media_reagents["L-histidine"]: 0.082,
    media_reagents["L-isoleucine"]: 0.0,
    media_reagents["L-leucine"]: 0.4,
    media_reagents["L-lysine"]: 0.0,
    media_reagents["L-methionine"]: 0.0,
    media_reagents["L-phenylalanine"]: 0.0,
    media_reagents["L-proline"]: 0.0,
    media_reagents["L-serine"]: 0.0,
    media_reagents["L-threonine"]: 0.0,
    media_reagents["L-tryptophan"]: 0.0,
    media_reagents["L-tyrosine"]: 0.0,
    media_reagents["L-valine"]: 0.0,
    media_reagents["potassium"]: 4.44,
    media_reagents["sodium"]: 0.75,
    media_reagents["biotin"]: 0.00000142,
    media_reagents["choline"]: 0.000092,
    media_reagents["riboflavin"]: 0.0,
    media_reagents["thiamine(1+)"]: 0.0,
    media_reagents["myo-inositol"]: 0.00193,
